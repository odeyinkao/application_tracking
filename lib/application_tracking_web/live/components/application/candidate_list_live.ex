defmodule ApplicationTrackingWeb.CandidateListLive do
  ...
  def render(assigns) do
    ...
    <div class=" pr-4 sm:pr-6 lg:pr-8 lg:flex-shrink-0 lg:border-l lg:border-gray-200 xl:border-r-2 bg-white"">
      ...
      <p class="mt-1 text-sm text-gray-500">List of Applicants <%= @selected_status %> stage.</p>
      <fieldset class="mt-2">
        ...
        <div class="divide-y divide-gray-200">
          ...
          <%= for candidate <- @candidates  do %>
            <%= candidate_item(%{candidate: candidate, selected_candidate_id: @selected_candidate_id}) %>
          <% end %>
  ...
  defp candidate_item(assigns) do
    ...
    ~L"""
      <div class="relative flex items-start py-4" phx-click="candidate_selected"  phx-value-id="<%= @candidate.id %>">
